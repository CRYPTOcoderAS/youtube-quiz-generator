...
app.get('/generate-quiz', async (req, res) => {
    ...
    try {
        ...
        const prompt = `"You are a sophisticated natural language processing AI adept at analyzing YouTube video transcripts. Upon receiving a transcript, execute the following tasks:
        ...
        4. Output should be stringified json. With no extra things such as code fence or code blocks. Make sure its always stringified json and it can be parseable no error should arise if the output is piped into JSON.parse function in javascript.
